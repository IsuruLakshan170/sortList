...
@Component({
  selector: 'app-test-cams-pick-list',
  templateUrl: './test-cams-pick-list.component.html',
  styleUrls: ['./test-cams-pick-list.component.scss']
})
export class TestCamsPickListComponent implements OnInit {
